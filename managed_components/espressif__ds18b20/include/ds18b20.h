...
/**
 * @brief Get temperature address of DS18B20
 *
 * @param[in] ds18b20 DS18B20 device handle returned by `ds18b20_new_device`
 * @param[out] addr conversion result from DS18B20
 * @return
 *      - ESP_OK: Get address successfully
 *      - ESP_ERR_INVALID_ARG: Get address failed due to invalid argument
 */
esp_err_t ds18b20_address(ds18b20_device_handle_t ds18b20, onewire_device_address_t *addr);
